...
public class OrganisationProfileFragment extends Fragment {
    ...
    private void initViews() {
        ...
        activityAdapter = new ActivityListAdapter(getContext(), R.layout.row_activity, list, this.getActivity());
        projectAdapter = new ProjectListAdapter(getContext(), R.layout.row_organisation_project, projects, this.getActivity());
