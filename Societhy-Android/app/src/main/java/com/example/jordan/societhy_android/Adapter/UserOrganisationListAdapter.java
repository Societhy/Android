 ...
 */
public class UserOrganisationListAdapter extends ArrayAdapter<UserActivityModel> {
    private static LayoutInflater mInflater = null;
    private static List<UserActivityModel> objs;
    private Context context;
    private Activity activity;

    public UserOrganisationListAdapter(Context context, int layout, List<UserActivityModel> objects, Activity activity) {
